package in.zestic.common.web.client.config;

import in.zestic.common.web.client.handler.WebClientInvocationHandler;
import in.zestic.common.web.client.annotation.WebClient;
